            ...
            <div class="main-header-container container-fluid">
                ...
                <div class="header-content-left">
                    ...
                    <div class="header-element">
                        <!-- Start::header-link -->
                        <a class="header-link animated-arrow " href="{{route('home')}}">
                            <h6>My Note</h6>
                        </a>
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu"
                            ...
                            <li>
                                <div class="main-header-profile bg-primary menu-header-content text-fixed-white">
                                    <div class="my-auto">
                                        <h6 class="mb-0 lh-1 text-fixed-white">name</h6><span
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                      ...
                      <button type="submit" class="btn btn-dark btn-outline-info">Add Note</button>
                    </form>
            </div>
        </div>
        </div>
